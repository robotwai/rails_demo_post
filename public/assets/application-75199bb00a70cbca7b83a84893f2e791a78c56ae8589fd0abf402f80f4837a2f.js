...
$(function(){
        $("#praise").click(function(){
            ...
            if(praise_img.attr("src") == ("app/assets/images/yizan.png")){
                $(this).html("<img src='app/assets/images/zan.png' id='praise-img' class='animation' />");
                ...
                $(this).html("<img src='app/assets/images/yizan.png' id='praise-img' class='animation' />");
